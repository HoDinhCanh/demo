<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST")
    {
        ...
        {
            $sql= "INSERT INTO users(username, password, role) VALUES('$u','$p','khách')";
            ...
            <div class="container" >
                <div class="signup-content">
                    <form method="POST" id="signup-form" class="signup-form">
                        <div style= "font-size: 30px; text-align: Center; ">Đăng kí</div>
                        <div class="form-row">
                        ...
                        <a href="trangchu.php"><h3>về trang chủ</h3></a>
                        </div>
                    </form>
